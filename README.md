...
13. Licensing: the [Feminist Software Foundation License](https://github.com/FeministSoftwareFoundation/C-plus-Equality/blob/mistress/LICENSE).
...
* Equality between two variables is denoted by ==. Since everyone is equal, this always evaluates to true.
